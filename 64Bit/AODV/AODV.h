...
#define ROUTETABLE_ALLOC() (AODV_ROUTETABLE*)list_alloc(sizeof(AODV_ROUTETABLE),offsetof(AODV_ROUTETABLE,ele))
	...
	static NETSIM_IPAddress AODV_DEV_IP(NETSIM_ID dev)
	{
		if(dev)
...
#define AODV_DEV_IP4(dev) fn_NetSim_Stack_GetFirstIPAddressAsId(dev,4)
#define AODV_DEV_IP6(dev) fn_NetSim_Stack_GetFirstIPAddressAsId(dev,6)
#define AODV_DEV_IP_COPY(dev) IP_COPY(AODV_DEV_IP(dev))
